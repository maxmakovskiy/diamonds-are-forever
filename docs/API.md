...
- Update items' info
- Delete items
- Create new transfers/actions
- Delete transfers/actions
...
### Get item's details# Diamonds API
...
The response body is empty. The session cookie is removed.
...
### Get details of colored diamond
