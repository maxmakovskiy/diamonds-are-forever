...
//              });
    ...
    ColoredDiamondController coloredDiamondController = new ColoredDiamondController(itemsCache);
    ...
    ColoredGemstoneController coloredGemstoneController = new ColoredGemstoneController(itemsCache);
