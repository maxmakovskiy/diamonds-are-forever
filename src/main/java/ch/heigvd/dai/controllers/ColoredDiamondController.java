...
public class ColoredDiamondController {
  ...
  public void create(Context ctx) {
    ...
    try (Handle handle = Database.getInstance().jdbi.open()) {
      ...
      // erorr msg ?
      int lotId = itemDao.insertItem(cd.stockName, cd.purchaseDate, cd.origin, "colored diamond");
      cd.lotId = lotId;
  ...
  public void update(Context ctx) {
    ...
    try (Handle handle = Database.getInstance().jdbi.open()) {
      ...
      updatedItem.purchaseDate = cd.purchaseDate != null ? cd.purchaseDate : item.purchaseDate;
